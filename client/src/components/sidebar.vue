    ...
    <div>
        ...
        <div class="newList" v-if="listCreator">
            <div class="createList">
                <input class="inField" autocomplete="off" name="name" type="text" placeholder="List name" v-model="listName" />
                <br/><br>
                <button v-on:click="listCreator=false; listName=''">Cancel</button>
